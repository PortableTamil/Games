...
user in an INI file next to OpenTTDPortable.exe called OpenTTDPortable.ini. If
...
AppNamePortable.ini from this directory to OpenTTDPortable.ini next to
OpenTTDPortable.exe. The options in the INI file are as follows:
