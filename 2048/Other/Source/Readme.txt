...
user in an INI file next to 2048Portable.exe called 2048Portable.ini.
...
copy AppNamePortable.ini from this directory to 2048Portable.ini next to
2048Portable.exe. The options in the INI file are as follows:
