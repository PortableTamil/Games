...
user in an INI file next to LucasChessPortable.exe called LucasChessPortable.ini.
...
copy AppNamePortable.ini from this directory to LucasChessPortable.ini next to
LucasChessPortable.exe. The options in the INI file are as follows:
