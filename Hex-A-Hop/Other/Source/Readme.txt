...
user in an INI file next to Hex-A-HopPortable.exe called Hex-A-HopPortable.ini.
...
copy AppNamePortable.ini from this directory to Hex-A-HopPortable.ini next to
Hex-A-HopPortable.exe. The options in the INI file are as follows:
