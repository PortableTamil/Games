...
user in an INI file next to TileWorldPortable.exe called TileWorldPortable.ini.
...
copy AppNamePortable.ini from this directory to TileWorldPortable.ini next to
TileWorldPortable.exe. The options in the INI file are as follows:
