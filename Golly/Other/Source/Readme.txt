...
user in an INI file next to GollyPortable.exe called GollyPortable.ini.
...
copy AppNamePortable.ini from this directory to GollyPortable.ini next to
GollyPortable.exe. The options in the INI file are as follows:
