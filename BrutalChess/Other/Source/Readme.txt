DEVELOPER: Replace the three occurrences of BrutalChessPortable in this file
...
user in an INI file next to BrutalChessPortable.exe called BrutalChessPortable.ini.
...
copy AppNamePortable.ini from this directory to BrutalChessPortable.ini next to
BrutalChessPortable.exe. The options in the INI file are as follows:
