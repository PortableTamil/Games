...
user in an INI file next to Tick5Portable.exe called Tick5Portable.ini.
...
copy AppNamePortable.ini from this directory to Tick5Portable.ini next to
Tick5Portable.exe. The options in the INI file are as follows:
