DEVELOPER: Replace the three occurrences of XyePortable in this file
...
user in an INI file next to XyePortable.exe called XyePortable.ini.
...
copy AppNamePortable.ini from this directory to XyePortable.ini next to
XyePortable.exe. The options in the INI file are as follows:
