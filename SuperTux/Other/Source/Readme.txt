...
user in an INI file next to SuperTuxPortable.exe called SuperTuxPortable.ini.
...
copy AppNamePortable.ini from this directory to SuperTuxPortable.ini next to
SuperTuxPortable.exe. The options in the INI file are as follows:
