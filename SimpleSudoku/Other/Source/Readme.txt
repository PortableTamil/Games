DEVELOPER: Replace the three occurrences of SimpleSudokuPortable in this file
...
user in an INI file next to SimpleSudokuPortable.exe called SimpleSudokuPortable.ini.
...
copy AppNamePortable.ini from this directory to SimpleSudokuPortable.ini next to
SimpleSudokuPortable.exe. The options in the INI file are as follows:
