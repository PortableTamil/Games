...
user in an INI file next to WizznicPortable.exe called WizznicPortable.ini.
...
copy AppNamePortable.ini from this directory to WizznicPortable.ini next to
WizznicPortable.exe. The options in the INI file are as follows:
