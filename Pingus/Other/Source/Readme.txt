...
user in an INI file next to PingusPortable.exe called PingusPortable.ini.
...
copy AppNamePortable.ini from this directory to PingusPortable.ini next to
PingusPortable.exe. The options in the INI file are as follows:
