...
user in an INI file next to PushoverPortable.exe called PushoverPortable.ini.
...
copy AppNamePortable.ini from this directory to PushoverPortable.ini next to
PushoverPortable.exe. The options in the INI file are as follows:
