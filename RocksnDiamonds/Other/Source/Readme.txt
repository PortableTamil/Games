...
user in an INI file next to RocksnDiamondsPortable.exe called 
RocksnDiamondsPortable.ini. If you are happy with the default options, it is 
...
RocksnDiamondsPortable.ini next to RocksnDiamondsPortable.exe. The options in 
