...
user in an INI file next to GetSudokuPortable.exe called GetSudokuPortable.ini.
...
copy AppNamePortable.ini from this directory to GetSudokuPortable.ini next to
GetSudokuPortable.exe. The options in the INI file are as follows:
