...
user in an INI file next to T-3Portable.exe called T-3Portable.ini.
...
copy AppNamePortable.ini from this directory to T-3Portable.ini next to
T-3Portable.exe. The options in the INI file are as follows:
